...
def test_health_call_success(route, client, valid_jwt, mock_request, test_keys_and_token):
...
def test_health_call_404(route, client, valid_jwt, mock_request, test_keys_and_token):
    mock_request.side_effect = (
        spycloud_api_response(payload=test_keys_and_token["jwks"]),
...
def test_health_call_500(route, client, valid_jwt, mock_request, test_keys_and_token):
    mock_request.side_effect = (
        spycloud_api_response(payload=test_keys_and_token["jwks"]),
...
def test_health_call_ssl_error(route, client, valid_jwt, mock_request, test_keys_and_token):
